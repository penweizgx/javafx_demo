...
import com.example.app.service.impl.FinanceManageServiceImpl;
import com.example.app.service.impl.MockUserManageService;
import com.example.app.service.impl.StudentManageServiceImpl;
...
public class AppModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(StudentApiServiceImpl.class).in(Singleton.class);
        bind(FinanceApiServiceImpl.class).in(Singleton.class);
        ...
        bind(StudentManageService.class).to(StudentManageServiceImpl.class).in(Singleton.class);
        bind(FinanceManageService.class).to(FinanceManageServiceImpl.class).in(Singleton.class);
